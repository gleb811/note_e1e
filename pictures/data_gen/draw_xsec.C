...
if ((m_pip_p_model->GetMaximum()) > max) max = m_pip_p_model->GetMaximum();

if ((m_pip_pim_model->GetMaximum()) > max) max = m_pip_pim_model->GetMaximum();

if ((m_pim_p_model->GetMaximum()) > max) max = m_pim_p_model->GetMaximum();
...
if ((theta_p_model->GetMaximum()) > max) max = theta_p_model->GetMaximum();

if ((theta_pip_model->GetMaximum()) > max) max = theta_pip_model->GetMaximum();

if ((theta_pim_model->GetMaximum()) > max) max = theta_pim_model->GetMaximum();
...
if ((alpha_p_model->GetMaximum()) > max) max = alpha_p_model->GetMaximum();

if ((alpha_pip_model->GetMaximum()) > max) max = alpha_pip_model->GetMaximum();

if ((alpha_pim_model->GetMaximum()) > max) max = alpha_pim_model->GetMaximum();
