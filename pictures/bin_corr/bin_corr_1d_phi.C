...
phi_p->SetMaximum(max);


draw_1d_hist(10,phi_p,"","phi_proton","d#sigma/d#varphi (#mubn/rad)","#varphi_{p'} (deg)",1,"e1P","phi",i);

phi_p_bin_corr = h_bin_corr(phi_p,phi_p_sym);

cout << alpha_asym(phi_p_bin_corr) << "%" << endl;

draw_1d_hist(10,phi_p_bin_corr,"","phi_proton","d#sigma/d#varphi (#mubn/rad)","#varphi_{p'} (deg)",2,"e1AP same","phi",i);
...
phi_pim->SetMaximum(max);


draw_1d_hist(11,phi_pim,"","phi_pim","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{-}} (deg)",1,"e1P","phi",i);

phi_pim_bin_corr = h_bin_corr(phi_pim,phi_pim_sym);

cout << alpha_asym(phi_pim_bin_corr) << "%" << endl;

draw_1d_hist(11,phi_pim_bin_corr,"","phi_pim","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{-}} (deg)",2,"e1AP same","phi",i);
...
phi_pip->SetMaximum(max);


draw_1d_hist(12,phi_pip,"","phi_pip","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{+}} (deg)",1,"e1P","phi",i);

phi_pip_bin_corr = h_bin_corr(phi_pip,phi_pip_sym);

cout << alpha_asym(phi_pip_bin_corr) << "%" << endl;

draw_1d_hist(12,phi_pip_bin_corr,"","phi_pip","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{+}} (deg)",2,"e1AP same","phi",i);
