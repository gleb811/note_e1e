...
TFile *file_out = new TFile("out_cr_sec_all_top_final_bin_corr_phi.root","RECREATE");
...
gDirectory->GetObject(qqq.str().c_str(),phi_p_bin_corr);
qqq.str("");
...
gDirectory->GetObject(qqq.str().c_str(),phi_pim_bin_corr);
qqq.str("");
...
gDirectory->GetObject(qqq.str().c_str(),phi_pip_bin_corr);
qqq.str("");
...
phi_p_bin_corr->Scale(factor);
phi_pim_bin_corr->Scale(factor);
phi_pip_bin_corr->Scale(factor);
