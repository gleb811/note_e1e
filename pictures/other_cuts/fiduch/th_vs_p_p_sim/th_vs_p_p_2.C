...
TH1 *h2;
c->cd();
MyFile->GetObject("th_vs_p_sim/th_vs_p_p_1_sim_2",h);
h->Draw("colz");
...
TF1 *f9 = new TF1("f9",funct_new2, 0.3+0.07,1.8,2);
 f9->SetParameter(0,1);
...
TF1 *f7 = new TF1("f7",funct_new2, 0.3+0.04,1.8,2);
...
c->SaveAs("p_th_vs_p_sim_sector2.pdf");   
