...
TH1 *h2;
c->cd();
MyFile->GetObject("th_vs_p_sim/th_vs_p_pim_1_sim_4",h);
...
TF1 *f6 = new TF1("f3",funct2, 0.05,0.7,2);
 f6->SetParameter(0,55.);
 f6->SetParameter(1,-0.31);
  f6->SetLineColor(kBlack);
  f6->SetLineWidth(2);
// f6->Draw("same"); 
 
 
TF1 *f7 = new TF1("f3",funct2, 0.05,0.7,2);
 f7->SetParameter(0,66.);
 f7->SetParameter(1,-0.31);
  f7->SetLineColor(kBlack);
  f7->SetLineWidth(2);
 f7->Draw("same"); 
 
TF1 *f8 = new TF1("f8",funct2, 0.05,0.7,2);
 f8->SetParameter(0,62.);
 f8->SetParameter(1,-0.31);
  f8->SetLineColor(kBlack);
  f8->SetLineWidth(2);
 f8->Draw("same"); 
 
c->SaveAs("pim_th_vs_p_sim_sector4.pdf");     
