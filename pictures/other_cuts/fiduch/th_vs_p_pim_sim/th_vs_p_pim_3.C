...
TH1 *h2;
c->cd();
MyFile->GetObject("th_vs_p_sim/th_vs_p_pim_1_sim_3",h);
...
TF1 *f4 = new TF1("f2",funct2, 0.05,0.5,2);
 f4->SetParameter(0,80.);
...
TF1 *f5 = new TF1("f3",funct2, 0.05,0.5,2);
 f5->SetParameter(0,71.);
 f5->SetParameter(1,-0.08);
  f5->SetLineColor(kBlack);
  f5->SetLineWidth(2);
 f5->Draw("same");   


TF1 *f6 = new TF1("62",funct2, 0.05,0.7,2);
 f6->SetParameter(0,56.);
f6->SetParameter(1,-0.055);
  f6->SetLineColor(kBlack);
  f6->SetLineWidth(2);
// f6->Draw("same"); 
 
TF1 *f7 = new TF1("62",funct2, 0.05,0.7,2);
 f7->SetParameter(0,50.);
f7->SetParameter(1,-0.055);
  f7->SetLineColor(kBlack);
  f7->SetLineWidth(2);
// f7->Draw("same");  
 
TF1 *f8 = new TF1("62",funct2, 0.05,0.9,2);
 f8->SetParameter(0,11.5);
f8->SetParameter(1,-0.055);
  f8->SetLineColor(kBlack);
  f8->SetLineWidth(2);
// f8->Draw("same");   
 
TF1 *f9 = new TF1("62",funct2, 0.05,0.9,2);
 f9->SetParameter(0,16.5);
f9->SetParameter(1,-0.055);
  f9->SetLineColor(kBlack);
  f9->SetLineWidth(2);
// f9->Draw("same"); 
 
c->SaveAs("pim_th_vs_p_sim_sector3.pdf");    
