...
TH1 *h2;
c->cd();
MyFile->GetObject("th_vs_p_sim/th_vs_p_e_1_sim_5",h);
...
TF1 *f4 = new TF1("f2",thmin, 0.05,2.2,2);
 f4->SetParameter(0,16.3);
 f4->SetParameter(1,-0.72);
  f4->SetLineColor(kBlack);
  f4->SetLineWidth(2);
 f4->Draw("same"); 
 
TF1 *f9 = new TF1("f9",thmin, 0.05,2.2,2);
 f9->SetParameter(0,14.7);
 f9->SetParameter(1,-0.72);
...
TF1 *f6 = new TF1("f3",thmin, 0.05,2.2,2);
 f6->SetParameter(0,12.5);
...
TF1 *f7 = new TF1("f3",thmin, 0.05,2.2,2);
 f7->SetParameter(0,15.);
 f7->SetParameter(1,-0.18);
  f7->SetLineColor(kBlack);
  f7->SetLineWidth(2);
// f7->Draw("same"); 
     
c->SaveAs("el_th_vs_p_sim_sector5.pdf");
