...
Tg2->GetYaxis()->SetTitleOffset(1.);
  ...
  TMarker *mark = new TMarker();
   ...
   mark->DrawMarker(1.65,5.);

   TLatex t;
//   t.SetTextAlign(33);
   t.SetTextSize(0.04);
   t.DrawLatex(1.675,4.5,"M. Ripani Q^{2} = 0.65 GeV^{2}");
...
//   t.SetTextAlign(33);
   t.SetTextSize(0.04);
   t.DrawLatex(1.68,6.5,"e1e Q^{2} = 0.625 GeV^{2}");  
...
//   t.SetTextAlign(33);
  ...
  TMarker *mark6 = new TMarker();
   ...
   mark6->DrawMarker(1.65,11.);
   mark6->SetMarkerSize(2); 
   TLatex t;
//   t.SetTextAlign(33);
   t.SetTextSize(0.04);
   t.DrawLatex(1.68,10.5,"e1e Q^{2} = 0.525 GeV^{2}");   
  ...
  TMarker *mark7 = new TMarker();
   ...
   mark7->DrawMarker(1.65,13.);
   mark7->SetMarkerSize(2);
   TLatex t;
//   t.SetTextAlign(33);
   t.SetTextSize(0.04);
   t.DrawLatex(1.68,12.5,"e1e Q^{2} = 0.475 GeV^{2}");       
...
file3 << "/home/gleb/e1e/e1e/2picross-sect/q206065/jopa";
 cout << file3.str() << "\n";
...
file7 << "/home/gleb/e1e/e1e/2picross-sect/q205506/jopa";
 cout << file7.str() << "\n";
...
file9 << "/home/gleb/e1e/e1e/2picross-sect/q205055/jopa";
 cout << file9.str() << "\n";
...
file8 << "/home/gleb/e1e/e1e/2picross-sect/q204505/jopa";
 cout << file8.str() << "\n";
