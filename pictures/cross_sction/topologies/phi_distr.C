...
TH1D *phi_p_noempty,*phi_pim_noempty,*phi_pip_noempty;
...
TH1D *phi_p_model,*phi_pim_model,*phi_pip_model;
...
if (canvas < 4)c->cd(canvas)->SetTopMargin(0.2);
if (canvas < 4)c->cd(canvas)->SetBottomMargin(0.17);
if (canvas >= 4)c->cd(canvas)->SetTopMargin(0.01);
if (canvas >= 4)c->cd(canvas)->SetBottomMargin(0.17);
...
qqq.str("");
qqq << "q2_" << Q2_bin << "/w_" << W_bin[i] << "/phi_proton_noempt";
gDirectory->GetObject(qqq.str().c_str(),phi_p_noempty);
qqq.str("");

qqq.str("");
qqq << "q2_" << Q2_bin << "/w_" << W_bin[i] << "/model_phi_proton";
gDirectory->GetObject(qqq.str().c_str(),phi_p_model);
qqq.str("");
...
qqq.str("");
qqq << "q2_" << Q2_bin << "/w_" << W_bin[i] << "/phi_pim_noempt";
gDirectory->GetObject(qqq.str().c_str(),phi_pim_noempty);
qqq.str("");

qqq.str("");
qqq << "q2_" << Q2_bin << "/w_" << W_bin[i] << "/model_phi_pim";
gDirectory->GetObject(qqq.str().c_str(),phi_pim_model);
qqq.str("");
...
qqq.str("");
qqq << "q2_" << Q2_bin << "/w_" << W_bin[i] << "/phi_pip_noempt";
gDirectory->GetObject(qqq.str().c_str(),phi_pip_noempty);
qqq.str("");

qqq.str("");
qqq << "q2_" << Q2_bin << "/w_" << W_bin[i] << "/model_phi_pip";
gDirectory->GetObject(qqq.str().c_str(),phi_pip_model);
qqq.str("");
...
max = (phi_p->GetMaximum())/2.;

phi_p_model->SetMaximum(max);
phi_p_model->SetLineWidth(2);

draw_1d_hist(10,phi_p_model,"","phi_p_model","d#sigma/d#varphi (#mubn/rad)","#varphi_{p'} (deg)",3,"B","alpha",i);


draw_1d_hist(10,phi_p,"","phi_p","d#sigma/d#varphi (#mubn/rad)","#varphi_{p'} (deg)",1,"e1P same","alpha",i);

//alpha_p_noempty->Scale((alpha_p->Integral())/(alpha_p_noempty->Integral()));

draw_1d_hist(10,phi_p_noempty,"","phi_p_noempty","d#sigma/d#varphi (#mubn/rad)","#varphi_{p'} (deg)",2,"e1AP same","alpha",i);




max = (phi_pim->GetMaximum())/2.;

phi_pim_model->SetMaximum(max);
phi_pim_model->SetLineWidth(2);

draw_1d_hist(11,phi_pim_model,"","phi_pim_model","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{-}} (deg)",3,"B","alpha",i);


draw_1d_hist(11,phi_pim,"","phi_pim","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{-}} (deg)",1,"e1P same","alpha",i);

//alpha_p_noempty->Scale((alpha_p->Integral())/(alpha_p_noempty->Integral()));

draw_1d_hist(11,phi_pim_noempty,"","phi_pim_noempty","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{-}} (deg)",2,"e1AP same","alpha",i);



max = (phi_pip->GetMaximum())/2.;

phi_pip_model->SetMaximum(max);
phi_pip_model->SetLineWidth(2);

draw_1d_hist(12,phi_pip_model,"","phi_pip_model","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{+}} (deg)",3,"B","alpha",i);


draw_1d_hist(12,phi_pip,"","phi_pip","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{+}} (deg)",1,"e1P same","alpha",i);

//alpha_p_noempty->Scale((alpha_p->Integral())/(alpha_p_noempty->Integral()));

draw_1d_hist(12,phi_pip_noempty,"","phi_pip_noempty","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{+}} (deg)",2,"e1AP same","alpha",i);
