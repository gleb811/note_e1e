...
qqq << "cr_sect_Q2_" << "0" << (((4 + 0.5*0)))*(((0+1) % 2) + 10 -10*((0+1) % 2)) << "_" << "0" << (((4.5 + 0.5*0)))*(((0) % 2) + 10 -10*((0) % 2)) << "_int_stat_err.dat"; 
ofstream outputFile;
outputFile.open(qqq.str().c_str());

for (Int_t zzz = 1; zzz <= h_w[0]->GetNbinsX(); zzz++) {
if (h_w[0]->GetBinContent(zzz) > 0.) {

outputFile << std::fixed << std::setprecision(4);
outputFile << h_w[0]->GetBinCenter(zzz) << " ";
outputFile << std::fixed << std::setprecision(8);
outputFile << h_w[0]->GetBinContent(zzz) << " " << h_w[0]->GetBinError(zzz) << endl;
}
};

qqq.str("");

qqq << "cr_sect_Q2_" << "0" << (((4 + 0.5*0)))*(((0+1) % 2) + 10 -10*((0+1) % 2)) << "_" << "0" << (((4.5 + 0.5*0)))*(((0) % 2) + 10 -10*((0) % 2)) << "_int_stat_plus_sys_err.dat"; 
ofstream outputFile1;
outputFile1.open(qqq.str().c_str());

for (Int_t zzz = 1; zzz <= h_w[0]->GetNbinsX(); zzz++) {
if (h_w[0]->GetBinContent(zzz) > 0.) {

outputFile1 << std::fixed << std::setprecision(4);
outputFile1 << h_w[0]->GetBinCenter(zzz) << " ";
outputFile1 << std::fixed << std::setprecision(8);
outputFile1 << h_w[0]->GetBinContent(zzz) << " " << full_err[zzz-1][0] << endl;
}
};
...
qqq << "cr_sect_Q2_" << "0" << (((4 + 0.5*qq2)))*(((qq2+1) % 2) + 10 -10*((qq2+1) % 2)) << "_" << "0" << (((4.5 + 0.5*qq2)))*(((qq2) % 2) + 10 -10*((qq2) % 2)) << "_int_stat_err.dat"; 
ofstream outputFile;
outputFile.open(qqq.str().c_str());

for (Int_t zzz = 1; zzz <= h_w[qq2]->GetNbinsX(); zzz++) {
if (h_w[qq2]->GetBinContent(zzz) > 0.) {

outputFile << std::fixed << std::setprecision(4);
outputFile << h_w[qq2]->GetBinCenter(zzz) << " ";
outputFile << std::fixed << std::setprecision(8);
outputFile << h_w[qq2]->GetBinContent(zzz) << " " << h_w[qq2]->GetBinError(zzz) << endl;
}
};

qqq.str("");

qqq << "cr_sect_Q2_" << "0" << (((4 + 0.5*qq2)))*(((qq2+1) % 2) + 10 -10*((qq2+1) % 2)) << "_" << "0" << (((4.5 + 0.5*qq2)))*(((qq2) % 2) + 10 -10*((qq2) % 2)) << "_int_stat_plus_sys_err.dat"; 
ofstream outputFile1;
outputFile1.open(qqq.str().c_str());
...
outputFile1 << std::fixed << std::setprecision(4);
outputFile1 << h_w[qq2]->GetBinCenter(zzz) << " ";
outputFile1 << std::fixed << std::setprecision(8);
outputFile1 << h_w[qq2]->GetBinContent(zzz) << " " << full_err[zzz-1][qq2] << endl;
}
};
